    ...
    return (
        ...
        >
            ...
            <View style={{
                ...
                left: 20,
                alignItems: 'center',
                backgroundColor: SCREEN_WIDTH > SCREEN_HEIGHT ? 'rgba(0, 0, 0, 0.4)' : 'rgba(256, 256, 256, 0.3)',
                padding: 5,
                ...
                <Text
                    ...
                    style={{
                        fontSize: 50,
                        color: SCREEN_WIDTH > SCREEN_HEIGHT ? '#fc951a' : '#373331',
                    }}>{item.name}</Text>
